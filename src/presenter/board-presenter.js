...
import PointsListView from '../view/events-view.js';
...
export default class BoardPresenter {
  ...
  get points() {
    ...
    sorting[this.#currSortType](filteredPoints);
  ...
  createPoint = (callback) => {
    this.#currSortType = SortType.DAY;
  ...
  #renderSort = () => {
    this.#sortComponent = new SortingView(this.#currSortType);
